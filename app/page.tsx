...
export default function Home() {
  return (
    <main>
      ...
      {/* ============ HERO ============ */}
<section className="hero" style={{ paddingTop: "clamp(40px,6vw,80px)" }}>        <div className="hero-bg" aria-hidden="true">
      ...
      <section className="section">
        <div className="container split split--rev">
          <div className="media">
            <img src="/ai-marketing.jpg" alt="AI-powered digital marketing dashboard showing analytics and campaign performance" style={{ width: "100%", borderRadius: "var(--radius)", border: "1px solid var(--line)" }} />
          </div>
          <div>
